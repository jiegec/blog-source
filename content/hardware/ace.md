...
最近几天分析了 TileLink 的缓存一致性协议部分内容，见[TileLink 总线协议分析](/hardware/2022/05/09/tilelink/)，趁此机会研究一下之前尝试过研究，但是因为缺少一些基础知识而弃坑的 ACE 协议分析。
...
首先来看一下 ACE 的缓存状态模型，我在之前的[缓存一致性协议分析](/hardware/2021/12/17/cache-coherency-protocol/)中也分析过，它有这么五种，就是 MOESI 的不同说法：
