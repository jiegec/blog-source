...
802.11ax 可以提供 1960 个子载波（间距从 312.5 kHz 缩小到 78.125 kHz），调制方式从 256-QAM 提升到 1024-QAM，但是 \\( T_{SYM} \\) 也提高到了 \\( 13.6 \mu s \\)，最大数据速率是 \\( 1960 * 1000000 / 13.6 * 10 * 5 / 6 * 8 = 9607.8 \textit{Mbps} \\)。
