...
顺带 @FactorialN 同学提醒我在这里提一句：包装里有电影适配器，不太环保。
...
目前已经测试过正常使用的：VSCode、Google Chrome、Alacrity、iStat Menus、Alfred、Rectangle、Typora、Microsoft Office、Karabiner Elements、Jetbrains Toolbox、WeChat、CineBench、Dozer。
