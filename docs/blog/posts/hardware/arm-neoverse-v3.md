...
![](./arm-neoverse-v2-btb-size-uncond-4b.png)

CPI 在 1024 条分支之前能达到约 0.5 的 CPI，这代表 Neoverse V3 继承了 Neoverse V2 的 two taken 能力。之后到 8192 条分支之前的 IPC 等于 1，到 16384 条分支时 CPI 等于 2，最后到 32768 条分支时 CPI 等于 6。

性能图像和 Neoverse V2 相同。Neoverse V2 的 [BTB 官方描述](https://hc2023.hotchips.org/assets/program/conference/day1/CPU1/HC2023.Arm.MagnusBruce.v04.FINAL.pdf)是：

- 10x larger nanoBTB (P.S. Neoverse V1 的 nanoBTB 是 96 entry)
- Split main BTB into two levels with 50% more entries（P.S. Neoverse V1 的 main BTB 是 8K entry）

因此推算 Neoverse V2 和 Neoverse V3 有相同的三级 BTB 结构：
...
主要疑点在于，16384 条分支的情况下，如何实现 2 的 CPI，目前还缺少解释。
