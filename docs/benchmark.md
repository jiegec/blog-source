...
- [3C6000 GCC 15.1.0 -O3 -flto: 4.63, 2.10/GHz](./data/others/SPEC_INT_2017_Loongson_3C6000_O3_GCC_15_O3-flto.txt)
...
2. `-march=native` 或 `-msimd=lasx`: 约 8% 提升，`4.50/4.17=1.08`
3. GCC 15.1.0 vs GCC 14.2.0: 约 7% 提升，`4.49/4.19=1.07`

结合这些提升，从 3A6000 GCC 14.2.0 -O3 的 4.35 分，估计 3A6000 GCC 15.1.0 -O3 -march=native -flto 的性能，大概是 `4.35*1.05*1.08*1.07=5.28`，估计值比 guee 实际测出来的 5.11 略高一点。本人目前没有 3A6000 环境，无法复现该结果。
