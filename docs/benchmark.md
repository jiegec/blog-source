...
- AWS Graviton 3 @ 2.5 GHz Neoverse V1（`-O3`）: [5.10](./data/int2017_rate1/AWS_Graviton_3_O3_001.txt)
...
1. SPEC INT 2017 Rate-1 结果受 `-flto` 影响很明显。`-Ofast` 和 `-O3` 区别很小，`-march=native` 和 `-ljemalloc` 影响很小。
...
4. Zen 4 Desktop(7500F): MPKI=4.53 Mispred=2.57%
...
- Qualcomm X1E80100 @ 4.0 GHz X Elite（`-O3`）: [13.7](./data/fp2017_rate1/Qualcomm_X1E80100_O3_001.txt)
...
- AWS Graviton 4 @ 2.75 GHz Neoverse V2（`-O3`）: [8.75](./data/fp2017_rate1/AWS_Graviton_4_O3_001.txt)
- Intel Xeon Platinum 8576C Emerald Rapids（`-O3`）: [8.14](./data/fp2017_rate1/Intel_Xeon_Platinum_8576C_O3_001.txt)
- AWS Graviton 3 @ 2.5 GHz Neoverse V1（`-O3`）: [7.80](./data/fp2017_rate1/AWS_Graviton_3_O3_001.txt)
...
2. 部分内核版本会显著影响 503.bwaves_r 和 507.cactuBSSN_r 项目的性能，详见 [Intel Spots A 3888.9% Performance Improvement In The Linux Kernel From One Line Of Code](https://www.phoronix.com/news/Intel-Linux-3888.9-Performance)、[mm, mmap: limit THP alignment of anonymous mappings to PMD-aligned sizes](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=d4148aeab412432bf928f311eca8a2ba52bb05df) 和 [kernel 6.10 THP causes abysmal performance drop](https://bugzilla.suse.com/show_bug.cgi?id=1229012)。
